...
/**
 * Klasse von der Button, Ball und Player erben und einige
 * grundlegene Sachen zur Verfügung stellt 
 * @author Dirk Aporius
 *
 */
public class TutorVolleyEntity
{
	private double 			x, y;
	private int				width, height;
	private BufferedImage	iBackground;
	
	public TutorVolleyEntity( BufferedImage iBackground, double x, double y, int width, int height )
	{
	 ...
	 * @return Bild
	 */
	protected BufferedImage getIBackground()
	{
	 ...
	 * @param background
	 */
	protected void setIBackground(BufferedImage background)
	{
