...
public class ApoDefenceEnemyLion extends ApoDefenceEnemy
{

	public ApoDefenceEnemyLion( BufferedImage iEnemy, ArrayList<Point> enemyWay, int level )
	{
		super( ApoDefenceConstants.ENEMY_LION, iEnemy, enemyWay );
		
		this.setValues( ApoDefenceConstants.ENEMY_LION_NAME,
						level, 
						ApoDefenceConstants.ENEMY_LION_HEALTH, 
						ApoDefenceConstants.ENEMY_LION_HEALTH_UPGRADE,
						ApoDefenceConstants.ENEMY_LION_SPEED, 
						ApoDefenceConstants.ENEMY_LION_SPEED_UPGRADE, 
						ApoDefenceConstants.ENEMY_LION_ARMOR, 
						ApoDefenceConstants.ENEMY_LION_ARMOR_UPGRADE,
						ApoDefenceConstants.ENEMY_LION_DAMAGE,
						ApoDefenceConstants.ENEMY_LION_DAMAGE_UPGRADE,
						ApoDefenceConstants.ENEMY_LION_MONEY * level / 2 );
	}
	
	public ApoDefenceEnemyLion( BufferedImage iEnemy, ArrayList<Point> enemyWay, int level, int startX, int startY )
	{
		super( ApoDefenceConstants.ENEMY_LION, iEnemy, enemyWay );
	...
	public void think( ApoDefenceGame game )
	{
		...
		} else
		{
			if ( ( !this.isBIce() ) && ( !this.isBLight() ) )
				...
				this.setCountWay( this.getCountWay() - ApoDefenceConstants.ENEMY_ICE_LION );
			...
			if ( this.getExtraTime() != -1 )
			{
				if  ( this.isBIce() )
				{
					speedX		= speedX	* ApoDefenceConstants.ENEMY_ICE_LION;
					speedY		= speedY	* ApoDefenceConstants.ENEMY_ICE_LION;
				} else if ( this.isBLight() )
				{
					speedX		= 0;
					speedY		= 0;
