 ...
 *
 */
public class TutorVolleyImage extends Component implements ImageObserver
{
	...
	private BufferedImage getImage(String BildName, boolean bLoad )
	{
		...
		if ( !bLoad ) 
		{
			try
			{
				img = ImageIO.read( TutorVolleyImage.class.getResource( BildName ) );
			} catch (IOException e)
			{
				e.printStackTrace();
			}
