...
public class ServerSelect extends Frame
{
        ...
        throws Exception
    {
        ...
        button1.addActionListener(new ServerSelect$1(this));
        ...
        button2.addActionListener(new ServerSelect$2(this));
        textField1.setFont(new Font("Dialog", 0, 14));
        textField1.setBounds(new Rectangle(105, 16, 194, 25));
        textField1.addActionListener(new ServerSelect$3(this));
