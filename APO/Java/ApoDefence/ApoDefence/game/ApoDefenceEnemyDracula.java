...
public class ApoDefenceEnemyDracula extends ApoDefenceEnemy
{

	public ApoDefenceEnemyDracula( BufferedImage iEnemy, ArrayList<Point> enemyWay, int level )
	{
		super( ApoDefenceConstants.ENEMY_DRACULA, iEnemy, enemyWay );
		
		this.setValues( ApoDefenceConstants.ENEMY_DRACULA_NAME,
						level, 
						ApoDefenceConstants.ENEMY_DRACULA_HEALTH, 
						ApoDefenceConstants.ENEMY_DRACULA_HEALTH_UPGRADE,
						ApoDefenceConstants.ENEMY_DRACULA_SPEED, 
						ApoDefenceConstants.ENEMY_DRACULA_SPEED_UPGRADE, 
						ApoDefenceConstants.ENEMY_DRACULA_ARMOR, 
						ApoDefenceConstants.ENEMY_DRACULA_ARMOR_UPGRADE,
						ApoDefenceConstants.ENEMY_DRACULA_DAMAGE,
						ApoDefenceConstants.ENEMY_DRACULA_DAMAGE_UPGRADE,
						ApoDefenceConstants.ENEMY_DRACULA_MONEY * level / 2 );
		
		this.setBUndead( true );
	}
	
	public ApoDefenceEnemyDracula( BufferedImage iEnemy, ArrayList<Point> enemyWay, int level, int startX, int startY )
	{
		super( ApoDefenceConstants.ENEMY_DRACULA, iEnemy, enemyWay );
