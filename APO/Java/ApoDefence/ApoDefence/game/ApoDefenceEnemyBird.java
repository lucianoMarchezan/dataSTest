...
public class ApoDefenceEnemyBird extends ApoDefenceEnemy
{

	public ApoDefenceEnemyBird( BufferedImage iEnemy, ArrayList<Point> enemyWay, int level )
	{
		super( ApoDefenceConstants.ENEMY_BIRD, iEnemy, enemyWay );
		
		this.setValues( ApoDefenceConstants.ENEMY_BIRD_NAME,
						level, 
						ApoDefenceConstants.ENEMY_BIRD_HEALTH, 
						ApoDefenceConstants.ENEMY_BIRD_HEALTH_UPGRADE,
						ApoDefenceConstants.ENEMY_BIRD_SPEED, 
						ApoDefenceConstants.ENEMY_BIRD_SPEED_UPGRADE, 
						ApoDefenceConstants.ENEMY_BIRD_ARMOR, 
						ApoDefenceConstants.ENEMY_BIRD_ARMOR_UPGRADE,
						ApoDefenceConstants.ENEMY_BIRD_DAMAGE,
						ApoDefenceConstants.ENEMY_BIRD_DAMAGE_UPGRADE,
						ApoDefenceConstants.ENEMY_BIRD_MONEY * (float)level / 2.0f );
	}
	
	public ApoDefenceEnemyBird( BufferedImage iEnemy, ArrayList<Point> enemyWay, int level, int startX, int startY )
	{
		super( ApoDefenceConstants.ENEMY_BIRD, iEnemy, enemyWay );
		...
		this.setValues( ApoDefenceConstants.ENEMY_BIRD_NAME,
						...
						ApoDefenceConstants.ENEMY_BIRD_DAMAGE,
						ApoDefenceConstants.ENEMY_BIRD_DAMAGE_UPGRADE,
						ApoDefenceConstants.ENEMY_BIRD_MONEY * level / 2 );
